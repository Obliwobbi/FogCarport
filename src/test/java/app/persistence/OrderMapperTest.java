package app.persistence;
    ...
    class OrderMapperTest
    {
        ...
        void setUp()
        {
                 ...
                 Statement stmt = connection.createStatement())
            {
                ...
                stmt.execute("""
                    ...
                    VALUES (1, 'SVG drawing data for carport 1...'),
                           (2, 'SVG drawing data for carport 2...'),
                           (3, 'SVG drawing data for carport 3...')
                """);
                ...
                stmt.execute("""
                    ...
                    VALUES (1, 'Brædt 25x200', '25x200 mm. trykimp. Brædt', 1, 'stk', 540.00, 20.00, 2.50, 300.00),
                           (2, 'Skruer 4.5x60', '4,5 x 60 mm. skruer 200 stk.', 200, 'pakke', NULL, NULL, NULL, 120.00),
                           (3, 'Bundskruer', 'Plastmo bundskruer 200 stk.', 200, 'pakke', NULL, NULL, NULL, 150.00)
                """);
                ...
                stmt.execute("""
                    ...
                    VALUES (1, '2024-01-15 10:30:00', 'AFVENTER ACCEPT', '2024-02-15 10:00:00', 1, 1, 1, 5000.00),
                           (2, '2024-01-10 14:20:00', 'GODKENDT', '2024-02-10 12:00:00', 2, 2, 2, 7500.00),
                           (3, '2024-01-05 09:15:00', 'AFSENDT', '2024-02-01 08:00:00', 3, 3, 3, 9200.00)
                """);
        ...
        void updateOrderStatus() throws DatabaseException
        {
            ...
            assertEquals("GODKENDT", updatedOrder.getStatus());
        }
        ...
        void getAllOrdersByStatusMultipleResults() throws DatabaseException
        {
            ...
            orderMapper.updateOrderStatus(4, "GODKENDT");
